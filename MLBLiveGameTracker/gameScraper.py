...
while True:
    ...
    try:
      sb_placeholder.dataframe(todays_steals,width=550, height=450, hide_index=True)
    except:
      pass
    
    todays_homers = todays_homers.sort_values(by=['HR','Team'], ascending=[False,True])
    try:
      hr_placeholder.dataframe(todays_homers,width=550, height=450, hide_index=True)
    except:
      pass
